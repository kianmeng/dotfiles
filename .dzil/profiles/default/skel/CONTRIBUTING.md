...
1. [Create a fork](https://help.github.com/articles/fork-a-repo/) of the [repository](https://github.com/kianmeng/{{lc $dist->name}}).
...
project.
    ...
    $ docker build -t {{lc $dist->name}} .
    $ docker run -it -v $(pwd):/root {{lc $dist->name}} bash
